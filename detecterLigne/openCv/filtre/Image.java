...
public class Image {
	...
	public Image createGrayscaleImage() throws IOException {// Cree une autre image, correpondant a
		...
		grayscaleImagePath = Util.rename("Gris.jpg", this.imgPath);
		// du
		// chemin
		// de l
		// image
	...
	public void enregistreImage() {
		...
		File f = new File(Util.rename("retouche.jpg", this.imgPath));
	...
	public static void main(String[] args) throws IOException {
		Image img = new Image("C:\\Users\\Axel\\eclipse-workspace\\Image\\src\\ressource\\1.jpg", "escalier");
